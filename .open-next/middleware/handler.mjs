...
// .next/server/edge/chunks/_2a7ce7e7._.js
var require_a7ce7e7 = __commonJS({
  ".next/server/edge/chunks/_2a7ce7e7._.js"() {
    "use strict";
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/_2a7ce7e7._.js", 84855, (e) => {
      e.v({ meta: { description: "Tech entrepreneur, product management consultant and coach. Founder of Blabigo, the AI Powered LinkedIn Personal Branding platform." }, navigation: { home: "Home", about: "About", projects: "Projects", contact: "Contact" }, home: { title: "Nabil Chouaib", subtitle: "Tech Entrepreneur & Product Management Consultant", description: "Founder of Blabigo - AI Powered LinkedIn Personal Branding Platform. Helping companies excel in product management and leadership through consulting and coaching." }, about: { title: "About Me", description: "I'm a tech entrepreneur, product management consultant and coach with a passion for building innovative solutions and helping teams level up their skills.", skills: { title: "Expertise", entrepreneurship: "Tech Entrepreneurship", consulting: "Product Management Consulting", coaching: "Team Coaching & Leadership" } }, projects: { title: "Featured Projects", viewProject: "View Project", liveDemo: "Live Demo", sourceCode: "Learn More" }, contact: { title: "Get In Touch", description: "Interested in product management consulting, team coaching, or collaboration opportunities? Let's connect!", email: "Email", linkedin: "LinkedIn", github: "GitHub" } });
    }, 38108, (e) => {
      e.v({ meta: { description: "Entrepreneur technologique, consultant en gestion de produit et coach. Fondateur de Blabigo, la plateforme de branding personnel LinkedIn aliment\xE9e par l'IA." }, navigation: { home: "Accueil", about: "\xC0 propos", projects: "Projets", contact: "Contact" }, home: { title: "Nabil Chouaib", subtitle: "Entrepreneur Tech & Consultant en Gestion de Produit", description: "Fondateur de Blabigo - plateforme de branding personnel LinkedIn aliment\xE9e par l'IA. J'aide les entreprises \xE0 exceller en gestion de produit et leadership gr\xE2ce au conseil et au coaching." }, about: { title: "\xC0 propos de moi", description: "Je suis un entrepreneur technologique, consultant en gestion de produit et coach passionn\xE9 par la cr\xE9ation de solutions innovantes et l'aide aux \xE9quipes \xE0 d\xE9velopper leurs comp\xE9tences.", skills: { title: "Expertise", entrepreneurship: "Entrepreneuriat Tech", consulting: "Conseil en Gestion de Produit", coaching: "Coaching d'\xC9quipe & Leadership" } }, projects: { title: "Projets Vedettes", viewProject: "Voir le projet", liveDemo: "D\xE9mo en direct", sourceCode: "En savoir plus" }, contact: { title: "Contactez-moi", description: "Int\xE9ress\xE9 par le conseil en gestion de produit, le coaching d'\xE9quipe ou les opportunit\xE9s de collaboration ? Contactons-nous !", email: "E-mail", linkedin: "LinkedIn", github: "GitHub" } });
    }, 4726, (e) => {
      e.v({ meta: { description: "Tech-Unternehmer, Produktmanagement-Berater und Coach. Gr\xFCnder von Blabigo, der KI-gest\xFCtzten LinkedIn Personal Branding Plattform." }, navigation: { home: "Startseite", about: "\xDCber mich", projects: "Projekte", contact: "Kontakt" }, home: { title: "Nabil Chouaib", subtitle: "Tech-Unternehmer & Produktmanagement-Berater", description: "Gr\xFCnder von Blabigo - KI-gest\xFCtzte LinkedIn Personal Branding Plattform. Ich helfe Unternehmen durch Consulting und Coaching bei Produktmanagement und F\xFChrung." }, about: { title: "\xDCber mich", description: "Ich bin ein Tech-Unternehmer, Produktmanagement-Berater und Coach mit einer Leidenschaft f\xFCr innovative L\xF6sungen und die Weiterentwicklung von Teams.", skills: { title: "Expertise", entrepreneurship: "Tech-Unternehmertum", consulting: "Produktmanagement-Beratung", coaching: "Team-Coaching & F\xFChrung" } }, projects: { title: "Ausgew\xE4hlte Projekte", viewProject: "Projekt ansehen", liveDemo: "Live Demo", sourceCode: "Mehr erfahren" }, contact: { title: "Kontakt aufnehmen", description: "Interesse an Produktmanagement-Beratung, Team-Coachings oder Kooperationsm\xF6glichkeiten? Lassen Sie uns in Kontakt treten!", email: "E-Mail", linkedin: "LinkedIn", github: "GitHub" } });
    }, 38022, (e, n, t) => {
      self._ENTRIES ||= {};
      let i = Promise.resolve().then(() => e.i(42738));
      i.catch(() => {
      }), self._ENTRIES.middleware_middleware = new Proxy(i, { get(e2, n2) {
        if ("then" === n2) return (n3, t3) => e2.then(n3, t3);
        let t2 = (...t3) => e2.then((e3) => (0, e3[n2])(...t3));
        return t2.then = (t3, i2) => e2.then((e3) => e3[n2]).then(t3, i2), t2;
      } });
    }]);
  }
});
...
`, rG.MISSING_INTL_API, s2);
      ...
      let ne = async ({ requestLocale: t10 }) => {
        let r10 = await t10;
        return r10 && ns.locales.includes(r10) || (r10 = ns.defaultLocale), { locale: r10, messages: (await e.f({ "../messages/de.json": { id: () => 4726, module: () => Promise.resolve().then(() => e.i(4726)) }, "../messages/en.json": { id: () => 84855, module: () => Promise.resolve().then(() => e.i(84855)) }, "../messages/fr.json": { id: () => 38108, module: () => Promise.resolve().then(() => e.i(38108)) } }).import(`../messages/${r10}.json`)).default };
      ...
      let ns = { locales: ["en", "de", "fr"], defaultLocale: "en" }, { Link: nl, redirect: nu, usePathname: nc, useRouter: nd, getPathname: nh } = function(e10) {
      ...
      e.s(["config", 0, { matcher: ["/((?!api|_next|_vercel|.*\\..*).*)"] }, "default", 0, nf], 99446);
      var np = e.i(99446);
      e.i(96588);
...
// .next/server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_daaca1b0.js
var require_turbopack_node_modules_next_dist_esm_build_templates_edge_wrapper_daaca1b0 = __commonJS({
  ".next/server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_daaca1b0.js"() {
    "use strict";
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_daaca1b0.js", { otherChunks: ["chunks/_2a7ce7e7._.js", "chunks/[root-of-the-server]__a0bafeed._.js"], runtimeModuleIds: [38022] }]), (() => {
      let e;
      ...
      n.a = function(e2, t2) {
        let r2 = this.m, n2 = t2 ? Object.assign([], { status: -1 }) : void 0, o2 = /* @__PURE__ */ new Set(), { resolve: u2, reject: l2, promise: i2 } = y(), a2 = Object.assign(i2, { [g]: r2.exports, [O]: (e3) => {
        ...
        Object.defineProperty(r2, "exports", s2), Object.defineProperty(r2, "namespaceObject", s2), e2(function(e3) {
          ...
          return t3.map((e4) => e4[O](a3)), i3.queueCount ? u3 : r3();
        }, function(e3) {
          e3 ? l2(a2[w] = e3) : u2(a2[g]), _(n2);
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    require_turbopack_node_modules_next_dist_esm_build_templates_edge_wrapper_daaca1b0();
  }
});
