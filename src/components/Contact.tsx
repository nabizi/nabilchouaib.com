      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Whether you're interested in product management consulting, team coaching, 
                or want to discuss how Blabigo can help enhance your LinkedIn presence, 
                I'm here to help you achieve your goals.
              </p>
              
              <div className="space-y-4">
                <a
                  href="mailto:contact@blabigo.com"
                  className="flex items-center space-x-3 text-gray-700 hover:text-blue-600 transition-colors"
                >
                  <Mail size={20} className="text-blue-600" />
                  <span>contact@blabigo.com</span>
                </a>
                ...
                <a
                  href="https://linkedin.com/in/nabilchouaib"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center space-x-3 text-gray-700 hover:text-blue-600 transition-colors"
                >
                  <Linkedin size={20} className="text-blue-600" />
                  <span>linkedin.com/in/nabilchouaib</span>
                </a>
              ...
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="consulting">Product Management Consulting</option>
        ...
        <div className="text-center mt-12">
          <p className="text-gray-500 text-sm">
            © 2024 Nabil Chouaib. Entrepreneur, Consultant, Coach.
          </p>
        </div>
      </div>
    </section>
